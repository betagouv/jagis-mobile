  ...
  Widget build(final BuildContext context) => Text.rich(
    TextSpan(
      children: [
        ...
        TextSpan(text: Localisation.euro(value), style: const DsfrTextStyle.bodySmBold(color: DsfrColors.grey50)),
      ],
    ),
  ...
  Widget build(final BuildContext context) => const Text.rich(
    TextSpan(
      children: [
        ...
        TextSpan(text: Localisation.gratuit, style: DsfrTextStyle.bodySmBold(color: DsfrColors.grey50)),
      ],
    ),
