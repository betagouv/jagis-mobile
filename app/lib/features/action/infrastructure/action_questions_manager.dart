...
class ActionQuestionsManager extends CursorManagerFromList<Question> {
  ActionQuestionsManager({required final DioHttpClient client, required final ActionType type, required final String code})
    : super(
        getList: () async {
