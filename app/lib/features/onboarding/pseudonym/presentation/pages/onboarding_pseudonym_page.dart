          ...
          children: [
            ...
            if (!isUserFranceConnect) ...[
              ...
              DsfrDateInput(
                ...
                // TODO(dsfr): Je ne connais pas le format de la date
                onChanged: (final value) {
                  final date = DateFormat('dd/MM/yyyy', 'fr_FR').parse(value);
                  context.read<OnboardingPseudonymBloc>().add(OnboardingBirthdateChanged(date));
                },
