...
void setCommunes() => FeatureContext.instance.dioMock.getM(
  ...
  responseData: [
    ...
    {'code': '39042', 'label': 'BAVERANS'},
    {'code': '39078', 'label': 'BREVANS'},
    {'code': '39101', 'label': 'CHAMPVANS'},
    {'code': '39150', 'label': 'CHOISEY'},
    {'code': '39182', 'label': 'CRISSEY'},
    {'code': '39198', 'label': 'DOLE'},
    {'code': '39233', 'label': 'FOUCHERANS'},
    {'code': '39252', 'label': 'GEVRY'},
    {'code': '39270', 'label': 'JOUHE'},
    {'code': '39345', 'label': 'MONNIERES'},
    {'code': '39405', 'label': 'PARCEY'},
    {'code': '39501', 'label': 'SAMPANS'},
    {'code': '39573', 'label': 'VILLETTE LES DOLE'},
  ],
);
