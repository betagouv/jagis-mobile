          ...
          child: Column(
            ...
            children: [
              ...
              ...recipe.ingredients
                  .map(
                    (final e) =>
                        Text('• ${e.quantity} ${e.unit} ${e.name}', style: const DsfrTextStyle.bodyMd(color: DsfrColors.grey50)),
                  )
              ...
              ...recipe.steps
                  .map(
                    (final e) => Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(text: '${e.order}. ', style: const DsfrTextStyle.bodyMdBold(color: DsfrColors.grey50)),
