...
import 'package:app/features/action/infrastructure/action_aid_mapper.dart';
...
abstract final class ActionClassicMapper {
  ...
  static ActionClassic fromJson(final Map<String, dynamic> json) => ActionClassic(
    ...
    aids: (json['aides'] as List<dynamic>).cast<Map<String, dynamic>>().map(ActionAidMapper.fromJson).toList(),
